    ...
    <div class="container mx-auto flex flex-wrap justify-center" >
        <div class="w-full sm:w-1/2 md:w-1/3">
            <div class="flex flex-col px-2 py-2 h-64 items-center justify-center relative portfolio order-first" onclick="">
                <img src="/images/herbal_logo.png" alt="" class="w-2/5 h-auto object-cover">
        ...
        <div class="w-full sm:w-1/2 md:w-1/3">
            <div class="flex flex-col px-2 py-2 h-64 items-center justify-center relative portfolio order-first" onclick="">
                <img src="/images/OMmeats.png" alt="" class="w-2/5 h-auto object-cover">
        ...
        <div class="w-full sm:w-1/2 md:w-1/3">
            <div class="flex px-2 py-2 h-64 items-center justify-center relative portfolio order-first" onclick="">
                <img src="/images/rocket.png" alt="" class="w-4/5 h-auto object-cover">
                <div class="portfolio-cover bg-rocket-green-trans flex flex-col">
        ...
        <div class="w-full sm:w-1/2 md:w-1/3">
            <div class="flex px-2 py-2 h-64 items-center justify-center relative portfolio order-first" onclick="">
                <img src="/images/cityfarm.png" alt="" class="w-2/5 h-3/5 object-cover">
                <div class="portfolio-cover bg-rocket-red-trans flex flex-col">
        ...
        <div class="w-full sm:w-1/2 md:w-1/3">
            <div class="flex px-2 py-2 h-64 items-center justify-center relative portfolio order-first" onclick="">
                <img src="/images/logoifn.jpg" alt="" class="w-3/5 h-3/5 object-cover">
                <div class="portfolio-cover bg-rocket-green-trans flex flex-col">
        ...
        <div class="w-full sm:w-1/2 md:w-1/3">
            <div class="flex px-2 py-2 h-64 items-center justify-center relative portfolio order-first" onclick="">
                <img src="/images/drumcondra_logo.png" alt="" class="h-15r w-auto object-cover">
                <div class="portfolio-cover bg-rocket-red-trans flex flex-col">
        ...
        <div class="w-full sm:w-1/2 md:w-1/3">
            <div class="flex px-2 py-2 h-64 items-center justify-center relative portfolio order-first" onclick="">
                <img src="/images/larryslogo_trans.png" alt="" class="h-12r w-auto object-cover">
                <div class="portfolio-cover bg-rocket-green-trans flex flex-col">
